...
function destVincenty(lat1, lon1, brng, dist) {
 ...
 return new google.maps.LatLng(toDeg(lat2), lon1 + toDeg(L));  // This line only changed from original script to avoid further importing since Google Maps types are already available
};
